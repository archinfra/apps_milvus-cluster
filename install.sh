...
install_release() {
  ...
  helm_cmd=(
    ...
    --set-string "standalone.persistence.persistentVolumeClaim.storageClass=${STORAGE_CLASS}"
    ...
    --set-string "woodpecker.persistence.storageClass=${STORAGE_CLASS}"
    --set-string "log.persistence.persistentVolumeClaim.storageClass=${STORAGE_CLASS}"
    ...
    --set-string "pulsarv3.zookeeper.volumes.data.storageClassName=${STORAGE_CLASS}"
    --set-string "pulsarv3.bookkeeper.replicaCount=${BOOKKEEPER_REPLICAS}"
    --set-string "pulsarv3.bookkeeper.volumes.common.storageClassName=${STORAGE_CLASS}"
    --set-string "pulsarv3.bookkeeper.volumes.journal.size=${BOOKKEEPER_JOURNAL_SIZE}"
    --set-string "pulsarv3.bookkeeper.volumes.journal.storageClassName=${STORAGE_CLASS}"
    --set-string "pulsarv3.bookkeeper.volumes.ledgers.size=${BOOKKEEPER_LEDGER_SIZE}"
    --set-string "pulsarv3.bookkeeper.volumes.ledgers.storageClassName=${STORAGE_CLASS}"
